      ...
      <div className="flex-between max-w-screen-xl w-full text-sm py-3 px-4">
        ...
        <div className="max-lg:hidden flex-between gap-x-9">
          ...
          <div className="w-80 max-md:w-72 relative hover:cursor-pointer">
            <input className="w-full py-3 px-2 mt-2 hover:cursor-pointer placeholder:text-sm rounded-md bg-black-200 border border-input  outline-5C469C focus:outline-indigo-900 italic mb-4  h-[49px]" type="text" placeholder="جستجو فیلم ؟" />
            <Image className="w-6 h-6 white-svg absolute  top-4 left-1" src={SVG_NAVBAR[0]} alt="searchbar" width={10} height={10} />
          </div>
        </div>
